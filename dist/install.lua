...
files["programs/lib/jarvis/config.lua.example"] = [[
-- Configuration for Jarvis
-- IMPORTANT: DO NOT COMMIT THIS FILE TO GITHUB.
-- On your ComputerCraft computer, create the file /etc/jarvis/config.lua with these contents.

local config = {}

-- Your OpenAI API key. You can get one from https://platform.openai.com/api-keys
-- Enclose your key in double quotes, for example: "sk-abcdefghijklmnopqrstuvwxyz"
config.openai_api_key = "YOUR_API_KEY_HERE"

-- The model to use. "gpt-4o" is a good default.
-- Other options include "gpt-4-turbo" or "gpt-3.5-turbo".
config.model = "gpt-4o"
